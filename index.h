    ...
    <div class="cards">
      ...
      <div class="card card-motion">
        ...
        <div class="slidecontainer">
          <input type="range" min="0" max="3" value="0" class="slider" onchange="onFanChange()" id="fan">
          <p id="speedDisplay">--</p>
        </div>
      </div>
      ...
      <script>
        ...
        if (!!window.EventSource) {
          ...
          source.addEventListener('fan_speed', function (e) {
         ...
         source.addEventListener('pump_speed', function (e) {
